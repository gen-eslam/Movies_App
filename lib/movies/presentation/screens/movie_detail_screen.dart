  ...
  Widget build(BuildContext context) {
    return BlocBuilder<MovieDetailsBloc, MovieDetailsState>(
      buildWhen: (previous, current) =>
          current.recommendationState.name == 'loaded' ||
          current.recommendationState.name == 'error',
            ...
            return CustomScrollView(
              ...
              slivers: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            '${AppString.genres} ${_showGenres(state.movieDetails!.genresList)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
                ...
                SliverPadding(
                  ...
                  sliver: _showRecommendations(state.recommendation),
                ),
              ],
            );
        ...
        (context, index) {
          return FadeInUp(
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                imageUrl:
                    ApiConstant.imageUrl(recommendation[index].backdropPath),
