...
import 'package:movieapp/movies/domain/entities/genres.dart';
...
class MovieDetailsModel extends MovieDetails {
  ...
  factory MovieDetailsModel.fromJson(Map<String,dynamic> json)=>MovieDetailsModel(
      ...
      genresList: List<GenresModel>.from(json['genres'].map((e)=>GenresModel.fromJson(e) )),
      overView: json['overview'], releaseDate: json['release_date'],
      runTime: json['runtime'], title: json['title'], voteAverage: json['vote_average'].toDouble);
}
